...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      if (user) {
        try {
          const userDoc = await getDoc(doc(db, "users", (user as any).uid));
          if (userDoc.exists()) {
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          >
            ...
            <div className="relative flex drop-shadow-2">
              <Image
                src={(user as any)?.photoURL || "/images/user/spartan.jpg"}
                width={160}
                height={160}
                style={{
                  width: "auto",
          ...
          <div className="mt-4 ">
            <div className="right-1 z-10 mb-4 ml-6 mr-6 mt-2 xsm:bottom-4 xsm:right-4">
              <Link
                href={`/settings`}
