          ...
          >
            <div className="col-span-3 flex items-center">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <div className="h-12.5 w-15 cursor-pointer rounded-md">
                  <Image
                    src={product?.image}
                    width={60}
                    height={50}
                ...
                <p className="cursor-pointer text-sm text-black dark:text-white">
                  {product?.name}
                </p>
              </div>
            </div>
            ...
            <div
              className="pointer col-span-1 flex items-center"
              onClick={() => handleDelete(product.id)}
            >
              <p className="cursor-pointer text-sm text-meta-3">Delete Item</p>
            </div>
          </div>
        ))
      ) : (
